...
class TestRequestParser(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ("s", DebuggerRequest(command=Command.STEP_INTO)),
        ("step", DebuggerRequest(command=Command.STEP_INTO)),
        ("n", DebuggerRequest(command=Command.STEP_OVER)),
        ("next", DebuggerRequest(command=Command.STEP_OVER)),
